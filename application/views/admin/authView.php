...
<head>
  ...
  <style type="text/css">
    body {
      background-image: url('<?= assets('images/luwutimur.jpg') ?>');
        ...
        <div class="animate form-login">
          <section class="">
            <form action="<?= site_url('admin/auth/check') ?>" method="POST">
              <h2 class="text-danger"><i class="fa fa-map-marker"></i> Wisata Luwu Timur</h2>
              <h1>Login Form</h1>
              ...
              <div>
                ...
                <a href="<?= site_url('') ?>"><i class="fa fa-long-arrow-left fa-2x" aria-hidden="true"></i>
                </a></p>
              </div>
            </form>
